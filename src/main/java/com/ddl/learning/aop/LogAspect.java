...
public class LogAspect {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        log.info("开始计时: {}  URI: {}", getDateFormat(new Date()), uri);
        //访问目标方法的参数 可动态改变参数值
        Object[] args = joinPoint.getArgs();
        //方法名获取
        String methodName = joinPoint.getSignature().getName();
        log.info("请求方法：{}, 请求参数: {}", methodName, JSONObject.toJSONString(args));
        ...
        log.info("log注解描述：{}", logAnno==null?"":logAnno.desc());
        long endTime = System.currentTimeMillis();
        log.info("结束计时: {},  URI: {},耗时：{}", getDateFormat(new Date()), uri, endTime - beginTime);
        //模拟异常
    ...
    private String getDateFormat(Date date){
        String fmt="yyyy-MM-dd HH:mm:SSS";
